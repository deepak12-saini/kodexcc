			...
			<table class="table table-striped table-bordered table-hover" id="example" >
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo $ProductionReports['NappUser']['name'].' '.$ProductionReports['NappUser']['lname']; ?></td>	
						
						<td>
						<?php 
							if($ProductionReports['ProductionReport']['user_id'] == $user_id){ ?>
							<a href="<?php echo SITEURL.'Production_reports/edit/'.$ProductionReports['ProductionReport']['id']; ?>" class="btn btn-mini btn-info">Edit</a>
						<?php } ?>				
						</td>					
					</tr>
					<?php $k++; endforeach; ?>

...
<main class="page-body page-body-2">
	...
	<section class="vc-row vc-row-o bg-img page-banner"  style="background-image:url(<?php echo SITEURL ;?>wp-content/uploads/product-data-sheet.jpg);">
		<div class="vc-col vc-col-o banner-content ctn ctn-md">	
			<h1 class="hd"></h1>
		</div>
	</section>
	<section class="vc-row vc-row-o sec-gap" >
		<div class="vc-col vc-col-o ctn txt-center txt-block" >	<h2 class="hd txt-green p">Product Data Sheets</h2>
			<div  class="txt-content txt-xl p" >
				<p>kodex has a specified Product Data Sheet (PDS) for each and every one of our solutions. To download a data sheet please select a category below or search for the product.</p>
			</div>
		</div>
	</section>
							...
							<?php foreach($category as $cats){ ?>							
								...
								<div class='document-icon-row'>
									...
									<div class="document-icon" data-id="8823">
										<a href="<?php echo $pdt['datasheet']; ?>" target="_blank" class="proimg">
											<img class="" src="<?php echo SITEURL.'productimg/'.$pdt['tds_image'] ;?>" title="" data-ext="pdf" />

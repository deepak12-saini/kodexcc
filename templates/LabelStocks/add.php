...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<?php echo $this->Form->create('LabelStock', ['class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data']); ?>

				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Label Name: </label>
					<div class="col-sm-9">
						<?php
						echo $this->Form->input('LabelStock.label', ['type' => 'text', 'div' => false, 'label' => false, 'class' => 'col-xs-10 col-sm-5', 'id' => 'label', 'placeholder' => 'Label Name']);
						?>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<?php
						echo $this->Form->input('LabelStock.size', ['type' => 'text', 'div' => false, 'label' => false, 'class' => 'col-xs-10 col-sm-5', 'id' => 'size', 'placeholder' => 'Size']);
						?>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<?php
						echo $this->Form->input('LabelStock.minimum', ['type' => 'text', 'div' => false, 'label' => false, 'class' => 'col-xs-10 col-sm-5', 'id' => 'minimum', 'placeholder' => 'Minimum Stock']);
						?>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">In Stock: </label>
					<div class="col-sm-9">
						<?php
						echo $this->Form->input('LabelStock.instock', ['type' => 'text', 'div' => false, 'label' => false, 'class' => 'col-xs-10 col-sm-5', 'id' => 'instock', 'placeholder' => 'In Stock']);
						?>
					</div>
				</div>

		...
		<div class="col-xs-12">
			...
			<table class="table table-striped table-bordered table-hover" id="simple-table" >
				...
				<tbody>
					...
					<td>
						<?php if ($st === 0) { ?>
							<a href="<?php echo h(SITEURL . 'materials/status/1/' . ($MaterialOrders['MaterialOrder']['id'] ?? '')); ?>" class="btn btn-mini btn-success">Accept</a>
						<?php } elseif ($st === 1) { ?>
							<a href="<?php echo h(SITEURL . 'materials/status/2/' . ($MaterialOrders['MaterialOrder']['id'] ?? '')); ?>" class="btn btn-mini btn-success">Complete</a>
						<?php } ?>	
					</td>
					</tr>
					<?php endforeach; ?>

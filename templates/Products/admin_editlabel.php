		...
		<?php echo $this->Form->create(null, ['class' => 'form-horizontal', 'role' => 'form', 'type' => 'file']); ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					...
					<?php $selCat = $labelArr['Label']['category_id'] ?? $labelArr['Label']['label_cate_id'] ?? ''; ?>
					...
					<option value="">Please select Label category </option>
						<?php foreach ($LabelCategory as $LabelCategoryArr) { ?>
							<option <?php if ((string)$selCat === (string)($LabelCategoryArr['LabelCategory']['id'] ?? '')) { echo 'selected'; } ?> value="<?php echo h($LabelCategoryArr['LabelCategory']['id'] ?? ''); ?>"><?php echo h($LabelCategoryArr['LabelCategory']['category'] ?? $LabelCategoryArr['LabelCategory']['name'] ?? ''); ?></option>
						<?php } ?>
					</select>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" name="data[Label][name]" value="<?php echo $labelArr['Label']['name']; ?>" id="name" class="col-xs-10 col-sm-5" placeholder="Label Name">
			...
			<div class="form-group">
				...
				&nbsp; &nbsp; &nbsp; <a href="<?php echo SITEURL.'products/download/'.$labelArr['Label']['url']; ?>" >Download Label</a> 
			</div>		
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Weight: </label>
				<div class="col-sm-9">
					<input type="text" placeholder="weight" value="<?php echo $labelArr['Label']['weight']; ?>" name="data[Label][weight]" id="weight" class="col-xs-10 col-sm-5">
				</div>
			</div>		
			<div class="form-group">

				...
				<div class="col-sm-9">
					...
					<option value="">Please select Label category </option>
						<?php foreach($LabelCategory as $LabelCategoryArr){?>
							<option <?php if($labelArr['Label']['label_cate_id'] == $LabelCategoryArr['LabelCategory']['id']){ echo 'selected'; }  ?> value="<?php echo $LabelCategoryArr['LabelCategory']['id']; ?>" ><?php echo $LabelCategoryArr['LabelCategory']['category']?></option>
						<?php }?>
					</select>

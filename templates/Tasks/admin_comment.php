	...
	<div class="page-content">
		<div class="page-header">
			<div class="right_btn pull-right" ><a href="<?php echo SITEURL.'admin/tasks'?>" class="btn btn-inverse" >Back</a></div>
	...
	<div>
							...
							<div class="profile-activity clearfix">
								<div>
									...
									<?php if(!empty($TaskAssigns['documents'])){ ?>
										<a href="<?php echo SITEURL.'admin/tasks/commentdownload/'.base64_encode(base64_encode($TaskAssigns['id']));?>"><i class="fa fa-download"></i></a>
									<?php } ?>
									<div class="time">
		...
		<div class="widget-box">
			<div class="widget-header">
				<h5>Task Documents <a href="<?php echo SITEURL.'admin/tasks/uploaddoc/'.$TaskAssign['Task']['task_id'] ?>" class="btn btn-mini btn-warning" style="float:right;">Upload Doc</a></h5>
			</div>
			<div class="widget-body">
				<div class="widget-main">
					...
					<p class="alert alert-info">
						<a href="<?php echo SITEURL.'admin/tasks/download/'.$TaskDocument['id']; ?>" target="blank">Download Document</a>&nbsp;
						<br>
						<small>
						...
						?> (<?php echo date('d M Y h:i a',strtotime($TaskDocument['created'])); ?>)</small>
					</p>
					<?php }else{ ?>

	...
	<div class="page-content">
		...
		<h1>DuroLab <small><i class="ace-icon fa fa-angle-double-right"></i> Upload Documents</small>
		</h1>
	</div>
	...
	<div class="row">
		...
		<?php echo $this->Form->create('Task',array('class'=>'form-horizontal','enctype'=>'multipart/form-data')); ?>
			...
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Document Title: </label>
				<div class="col-sm-9">

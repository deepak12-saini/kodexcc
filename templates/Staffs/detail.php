	...
	<div class="row">
		<div class="col-xs-12">
			...
			<table class="table table-striped table-bordered table-hover" id="simple-table" >
				...
				<!-- <tr><th>Non Conformance Raised</th><td><?php echo h($ComplaintArr['Conformance']['non_conforance_raised']); ?></td><tr> --><tr><th>Route Cause and Analysis:</th>
					<td>
				...
				<tr><th>Client Deatil</th><td><?php echo h($ComplaintArr['Conformance']['client_detail']); ?></td><tr>
				<tr><th>Other Deatil</th><td><?php echo h($ComplaintArr['Conformance']['other_detail']); ?></td><tr>
				<tr>
				<th>Download Doc</th>
				<td>

		...
		<div class="col-xs-12">
			...
			<table class="table table-striped table-bordered table-hover" id="simple-table" >
				...
				<tr>				
					...
					<th><?php echo $this->Paginator->sort('compaint_by','Complaint By'); ?></th>				
					<th><?php echo $this->Paginator->sort('compaint_to','Complaint To'); ?></th>
		  ...
		  <div class="modal-body">
			...
			<div class="col-xs-12">
				...
				<table class="table table-striped table-bordered table-hover"  >
					<tbody>
					<tr><th>Non Conformance Number: </th><td><span class="label label-inverse"><?php echo h($conformance['Conformance']['nc_number']); ?></span></td></tr>	
					
					<tr><th>Complaint By</th><td><?php echo '<span class="label label-info">'.$conformance['NappUser1']['name'].' '.$conformance['NappUser1']['lname'].'</span>'; ?></td><tr>					
					<tr><th>Complaint To</th><td>
							<?php
							foreach($conformance['ConformanceRelation'] as $napuser){
						if($napuser['NappUser']['id'] != $conformance['NappUser1']['id']){
							echo '<span class="label label-info">'.$napuser['NappUser']['name'].' '.$napuser['NappUser']['lname'].'</span>';
					...
					<tr><th>Non Conformance</th><td><?php echo h($conformance['Conformance']['non_conforance']); ?></td><tr>					
					...
					<tr><th>Corrective Action Taken</th><td><?php echo h($conformance['Conformance']['corrective_action_taken']); ?></td><tr>					
					<tr>

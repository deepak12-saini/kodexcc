		...
		<div class="col-xs-12">
			...
			<?php echo $this->Form->create('DuroOrder',array('class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data'));?>	
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<textarea name="data[ProductionReport][manufacturing_product]" id="manufacturing_product" class="col-xs-10 col-sm-5 ckeditor" placeholder="Production Report"><?php echo $ProductionReport['ProductionReport']['manufacturing_product'];?></textarea>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<textarea name="data[ProductionReport][manufacturing_packaged]" id="manufacturing_packaged" class="col-xs-10 col-sm-5 ckeditor" placeholder="Manufacturing Packaged"><?php echo $ProductionReport['ProductionReport']['manufacturing_packaged'];?></textarea>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Manufacturing Label: </label>
					<div class="col-sm-9">
						<textarea name="data[ProductionReport][manufacturing_labelled]" id="manufacturing_labelled" class="col-xs-10 col-sm-5 ckeditor" placeholder="Manufacturing labeled"><?php echo $ProductionReport['ProductionReport']['manufacturing_labelled'];?></textarea>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">WAREHOUSE RECEIVED GOODS -- SUPPLIER PODS: </label>
					<div class="col-sm-9">
						<textarea name="data[ProductionReport][warehouse_supplier_pod]" id="warehouse_supplier_pod" class="col-xs-10 col-sm-5 ckeditor" placeholder="WAREHOUSE RECEIVED GOODS -- SUPPLIER PODS"><?php echo $ProductionReport['ProductionReport']['warehouse_supplier_pod'];?></textarea>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">DESPATCHED GOODS --  CUSTOMER PODS: </label>
					<div class="col-sm-9">
						<textarea name="data[ProductionReport][warehouse_customer_pod]" id="warehouse_customer_pod" class="col-xs-10 col-sm-5 ckeditor" placeholder="WAREHOUSE RECEIVED GOODS -- SUPPLIER PODS"><?php echo $ProductionReport['ProductionReport']['warehouse_customer_pod'];?></textarea>
					</div>
				</div>				
				<div class="form-group">

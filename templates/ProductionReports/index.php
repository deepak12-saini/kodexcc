	...
	<div class="page-content">
		<div class="page-header">
			<h1>Production Report <a href="<?php echo SITEURL . 'production-reports/add'; ?>" class="btn btn-mini btn-primary"> Add New</a></h1>
		</div>
			...
			<table class="table table-striped table-bordered table-hover" id="example" >
				...
				<tbody>
					...
					<tr>
						...
						<td>
						<?php
							if (isset($ProductionReports['ProductionReport']['user_id'], $user_id) && $ProductionReports['ProductionReport']['user_id'] == $user_id) { ?>

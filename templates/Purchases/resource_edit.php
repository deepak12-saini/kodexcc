	...
	<div class="page-content">
		...
		<h1>Resource Requirement: <small><i class="ace-icon fa fa-angle-double-right"></i> Edit Resource Requirement:</small>
		</h1>
	</div>
		...
		<?php echo $this->Form->create('Purchase',array('class'=>'form-horizontal','enctype'=>'multipart/form-data')); ?>
			...
			<fieldset class="newitem" id="div_<?php echo $j; ?>" >
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="resource_requirement[]" value="<?php echo $PurchaseRequirement['resource_requirement']; ?>" class="col-xs-10 col-sm-5" required>
					</div>
				</div>	
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right new" for="form-field-1">Purpose/Project</label>
					<div class="col-sm-9">
						<input type="text" name="purpose_project[]" value="<?php echo $PurchaseRequirement['purpose_project']; ?>" class="col-xs-10 col-sm-5" required>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="time[]" value="<?php echo $PurchaseRequirement['time']; ?>" class="col-xs-10 col-sm-5" required>
					</div>
				</div>
					<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right new" for="form-field-1">Budget</label>
					<div class="col-sm-9">
						<input type="text" name="budget[]" value="<?php echo $PurchaseRequirement['budget']; ?>" class="col-xs-10 col-sm-5" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="remark[]" value="<?php echo $PurchaseRequirement['remark']; ?>" class="col-xs-10 col-sm-5" required>
					</div>
				</div>	
			</fieldset>

	<div class="page-content">
		<div class="page-header">
			<h1>QC Result <a href="<?php echo SITEURL; ?>productions/batch_count_sheet_add" class="btn btn-mini btn-info" >Add New</a></h1>
		</div>
		...
		<div class="col-xs-12">
			...
			<table class="table table-striped table-bordered table-hover" id="simple-table" >
				...
				<tbody>
					...
					<td><a href="<?php echo SITEURL; ?>productions/batch_count_sheet_edit/<?php echo h($BatchRegisterArrs['BatchCountSheet']['id']); ?>" class="btn btn-mini btn-info" >Edit</a></td>
					</tr>
					<?php endforeach; ?>

...
<a onclick="closeNav()" style="color:#fff; float:right; font-size:20px; cursor:pointer;">X</a>
 <iframe src="<?php echo SITEURL.'wp-content/uploads/Durotech Workshop  Presentation - final.pdf'?>" style="width:100%; height:590px;; border:none;"></iframe>										
</div>
				...
				<div class="box">
					...
					<div class="box-body">
						<?php if(($user['NappUser']['is_natspec_presentation'] == 1)  ||  ($is_access == 2)){ ?>
							...
							<br/><br/>
							<a class="btn btn-mini btn-inverse" style="float:right;" href="<?php echo SITEURL ?>users/questionlist">Continue To Architect  CPD Questionnaire</a>
					...
					<div class="widget-box light-border">
						...
						<div class="widget-body">
							<div class="widget-main padding-6">
								...
								<div class="alert alert-danger" style=" font-size:20px; padding:50px; ">To gain access to this document <a href="<?php echo SITEURL.'/users/presentation/otp'?>">Click Here</a> to receive a OTP(one time password) and gain access to the document.</div></a>

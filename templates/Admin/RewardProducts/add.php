...
<div class="page-content">
	...
	<h1>Reward Product <small><i class="ace-icon fa fa-angle-double-right"></i> Add New</small>
	</h1>
</div>
			...
			<div class="col-sm-9">
				<select name="RewardProduct[product_id]" class="col-xs-10 col-sm-5">
					<?php foreach ($product as $products) { ?>
							<option value="<?php echo h($products['Product']['id']); ?>"><?php echo h($products['Product']['title']); ?></option>
					<?php } ?>
				</select>
			</div>
		</div>

	<div class="page-content">
		<div class="page-header">
			<h1>
			All Durotech Employee <a href="<?php echo SITEURL.'admin/users/add_staff'; ?>" class="btn btn-mini btn-primary">Add</a>
		...
		<div class="col-xs-12">
			...
			<table class="table table-striped table-bordered table-hover" id="simple-table" >
				...
				<tbody>
					...
					<td> 				
					<a href="<?php echo SITEURL.'admin/users/edit_new_staff/'.$staffArrs['Staff']['id']; ?>" class="btn btn-mini btn-primary">Edit</a>					
					</td>
					</tr>
					<?php endforeach; ?>

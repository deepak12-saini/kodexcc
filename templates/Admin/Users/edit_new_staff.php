			...
			<?php echo $this->Form->create(null,array('class'=>'form-horizontal')); ?>
					...
					<div class="col-sm-9">
						<select id="dept_id" name="data[Staff][dept_id]" class="col-xs-10 col-sm-5" >
							...
							<?php foreach($departmentArr as $departments){ ?>
								<option <?php  if($departments['Department']['id'] == $staffArr['Staff']['dept_id']){ echo 'selected'; } ?> value="<?php echo $departments['Department']['id'];?>"><?php echo $departments['Department']['department_title'];?></option>
							<?php  }  ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<input type="radio" name="data[Staff][status]" <?php  if(1 == $staffArr['Staff']['status']){ echo 'checked'; } ?> value="1" > Active
						<input type="radio" name="data[Staff][status]" <?php  if(0 == $staffArr['Staff']['status']){ echo 'checked'; } ?> value="0" > Deactive
					</div>
				</div>
				<div class="form-group">

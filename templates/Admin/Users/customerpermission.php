	...
	<div class="page-content">
		...
		<div class="page-header">
			<h1><b><?php echo ucfirst($NappUser['NappUser']['name']).' '. ucfirst($NappUser['NappUser']['lname']);?></b>: <small> Permssions</small>
		...
		<div class="row">
			...
			echo $this->Form->create(null,array('class'=>'form-horizontal','enctype'=>'multipart/form-data')); ?>
				<input type="hidden" name="data[new]" value="1">
					...
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Customer Document Permission</small> </label>
					<div class="col-sm-9">
